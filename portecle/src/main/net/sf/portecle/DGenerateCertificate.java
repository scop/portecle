 ...
 * signature algorithm for inclusion in a KeyStore.  Allows the user to enter
 * the signature algorithm and validty period of the certificate in days as well
 * as all of the certificate attributes of a version 1 X.509 certificate.
 * The choice of available signature algorithms depends on the key pair generation
 * algorithm selected.
 */
class DGenerateCertificate extends JDialog
{
    ...
    private void initComponents(String sTitle)
    {
        ...
        // Signature Algorithm
        m_jlSigAlg = new JLabel(m_res.getString("DGenerateCertificate.m_jlSigAlg.text"));
        ...
        // Validity Period
        m_jlValidity = new JLabel(m_res.getString("DGenerateCertificate.m_jlValidity.text"));
        ...
        // Common Name
        m_jlCommonName = new JLabel(m_res.getString("DGenerateCertificate.m_jlCommonName.text"));
        ...
        // Organisation Unit
        m_jlOrganisationUnit = new JLabel(m_res.getString("DGenerateCertificate.m_jlOrganisationUnit.text"));
        ...
        // Organisation Name
        m_jlOrganisationName = new JLabel(m_res.getString("DGenerateCertificate.m_jlOrganisationName.text"));
        ...
        // Locality Name
        m_jlLocalityName = new JLabel(m_res.getString("DGenerateCertificate.m_jlLocalityName.text"));
        ...
        // State Name
        m_jlStateName = new JLabel(m_res.getString("DGenerateCertificate.m_jlStateName.text"));
        ...
        // Country Code
        m_jlCountryCode = new JLabel(m_res.getString("DGenerateCertificate.m_jlCountryCode.text"));
        ...
        // Email Address
        m_jlEmailAddress = new JLabel(m_res.getString("DGenerateCertificate.m_jlEmailAddress.text"));
        ...
        m_jbOK = new JButton(m_res.getString("DGenerateCertificate.m_jbOK.text"));
        ...
        m_jbCancel = new JButton(m_res.getString("DGenerateCertificate.m_jbCancel.text"));
    ...
    private boolean generateCertificate()
    {
        ...
        if ((sCommonName == null) && (sOrganisationUnit == null) &&
            ...
            (sEmailAddress == null))
        {
            JOptionPane.showMessageDialog(this, m_res.getString("DGenerateCertificate.ValueReqCertAttr.message"),
        ...
        {
            JOptionPane.showMessageDialog(this, m_res.getString("DGenerateCertificate.CountryCodeTwoChars.message"),
                                          getTitle(), JOptionPane.WARNING_MESSAGE);
            return false;
        }
    ...
    private int validateValidity(String sValidity)
    {
        ...
        {
            JOptionPane.showMessageDialog(this, m_res.getString("DGenerateCertificate.ValReqValidity.message"),
                                          getTitle(), JOptionPane.WARNING_MESSAGE);
            return BAD_VALIDITY;
        }
        ...
        {
            JOptionPane.showMessageDialog(this, m_res.getString("DGenerateCertificate.ValidityInteger.message"),
                                          getTitle(), JOptionPane.WARNING_MESSAGE);
            return BAD_VALIDITY;
        }
        ...
        if (iValidity < 1)
        {
            JOptionPane.showMessageDialog(this, m_res.getString("DGenerateCertificate.ValidityNonZero.message"),
                                          getTitle(), JOptionPane.WARNING_MESSAGE);
            return BAD_VALIDITY;
        }
