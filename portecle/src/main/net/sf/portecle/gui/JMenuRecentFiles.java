 ...
 * most recently accessed file is set as the first item shifting other
 * files down and the list contains no duplicates.  Note: only call
 * the add(JMenuItemRecentFile) to add recent file menu items when the
