 ...
 * to open files directly by activating a menu item either through normal
 * means or the mnemonic that reflects the menu items position in the list
 * of recent files.  An action listener should be added to actually
