 ...
 * is used to open a file from the menu item.
 */
class RecentFileActionListener
    implements ActionListener
{
	...
	/**
	 * Create an RecentFileActionListener for the supplied keystore file and fPortecle frame.
	 * 
