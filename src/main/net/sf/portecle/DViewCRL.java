    ...
    extends JDialog
{
    ...
    private void initComponents()
    {
        ...
        m_jbCrlExtensions.setMnemonic(m_res.getString(
            "DViewCRL.m_jbCrlExtensions.mnemonic").charAt(0));
        ...
        for (int iCnt = 0; iCnt < m_jtRevokedCerts.getColumnCount(); iCnt++) {
            TableColumn column = m_jtRevokedCerts.getColumnModel().getColumn(
                iCnt);
        ...
        m_jbCrlEntryExtensions.setMnemonic(m_res.getString(
    ...
    private void populateDialog()
    {
        ...
        m_jtfEffectiveDate.setText(DateFormat.getDateTimeInstance(
        ...
        m_jtfNextUpdate.setText(DateFormat.getDateTimeInstance(
    ...
    private void crlEntrySelection()
    {
        ...
        if (!listSelectionModel.isSelectionEmpty()) // Enry must be selected
        {
            ...
            if (listSelectionModel.getMinSelectionIndex() == listSelectionModel.getMaxSelectionIndex())
            {
                ...
                BigInteger serialNumber = (BigInteger) ((RevokedCertsTableModel) m_jtRevokedCerts.getModel()).getValueAt(
                    iRow, 0);
